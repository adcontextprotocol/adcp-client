...
describe('createAdcpServer', () => {
  ...
  describe('protocol task tools', () => {
    ...
    it('answers get_task_status/list_tasks from the scoped AdCP task registry only', async () => {
      ...
      assert.strictEqual(status.adcp_version, '3.1-rc.9');
      ...
      assert.strictEqual(listed.adcp_version, '3.1-rc.9');
      ...
      assert.strictEqual(badCursor.structuredContent.adcp_version, '3.1-rc.9');
    ...
    it('applies authInfo credential scanning to protocol task aliases', async () => {
      ...
      assert.strictEqual(status.structuredContent.adcp_version, '3.1-rc.9');
      ...
      assert.strictEqual(listed.structuredContent.adcp_version, '3.1-rc.9');
