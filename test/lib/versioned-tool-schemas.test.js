...
describe('version-aware tool JSON Schemas (#2678)', () => {
  it('selects distinct 3.0, 3.1, and 3.2 request schemas and reports the resolved release', () => {
    ...
    const v32 = getToolInputSchema('create_media_buy', { adcpVersion: '3.2.0-rc.2' });
    ...
    assert.strictEqual(v32.bundleKey, '3.2.0-rc.2');
    assert.strictEqual(v32.resolvedVersion, '3.2.0-rc.2');
