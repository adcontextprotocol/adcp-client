...
try {
  ...
  const canonicalSchemaSmoke = [
    "const canonical = m6.getCanonicalToolValidator('get_reporting_status', 'sync', { adcpVersion: '3.2.0-rc.6' });",
  ...
  writeFileSync(
    ...
    [
      ...
      "const invalid = validateRequest('get_products', {}, '3.2.0-rc.6');",
      ...
      '}',
      "const schema = loadRequestSchema('get_products', { version: '3.2.0-rc.6' });",
      "if (schema.$id !== 'https://adcontextprotocol.org/schemas/3.2.0-rc.6/media-buy/get-products-request.json') {",
      ...
      '}',
      "const errorArmTools = getToolsWithErrorArm('3.2.0-rc.6');",
