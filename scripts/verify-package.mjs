...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      "const invalid = validateRequest('get_products', {}, '3.2.0-rc.1');",
      ...
      '}',
      "const schema = loadRequestSchema('get_products', { version: '3.2.0-rc.1' });",
      ...
      '}',
      "const errorArmTools = getToolsWithErrorArm('3.2.0-rc.1');",
