...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      "const invalid = validateRequest('get_products', {}, '3.2.0-beta.11');",
      ...
      '}',
      "const schema = loadRequestSchema('get_products', { version: '3.2.0-beta.11' });",
      ...
      '}',
      "const errorArmTools = getToolsWithErrorArm('3.2.0-beta.11');",
