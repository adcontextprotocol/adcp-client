...
// ledger adds ten public module artifacts; the draft consumer-status ingest
// adds eight runtime artifacts and eight explicitly published preview files.
const MAX_PACKED_FILE_COUNT = 5_976;
