...
const JSTS_UNDER_RESOLUTION_ALIASES: Array<{ numbered: string; base: string }> = [
  ...
  { numbered: 'AssetVariant2', base: 'AssetVariant' },
  { numbered: 'VASTAsset2', base: 'VASTAsset' },
  { numbered: 'DAASTAsset2', base: 'DAASTAsset' },
  { numbered: 'AssetVariant3', base: 'AssetVariant' },
  { numbered: 'VASTAsset3', base: 'VASTAsset' },
  { numbered: 'DAASTAsset3', base: 'DAASTAsset' },
  { numbered: 'AssetVariant4', base: 'AssetVariant' },
  { numbered: 'VASTAsset4', base: 'VASTAsset' },
  { numbered: 'DAASTAsset4', base: 'DAASTAsset' },
  { numbered: 'AssetVariant5', base: 'AssetVariant' },
  { numbered: 'VASTAsset5', base: 'VASTAsset' },
  { numbered: 'DAASTAsset5', base: 'DAASTAsset' },
  { numbered: 'AssetVariant6', base: 'AssetVariant' },
  { numbered: 'VASTAsset6', base: 'VASTAsset' },
  { numbered: 'DAASTAsset6', base: 'DAASTAsset' },
  { numbered: 'AssetVariant7', base: 'AssetVariant' },
  { numbered: 'VASTAsset7', base: 'VASTAsset' },
  { numbered: 'DAASTAsset7', base: 'DAASTAsset' },
];
