...
//   schemas/cache/<adcp_version>/core/media-buy-available-action-id.json (absent from this cache; legacy-only table)
 ...
 */
export const STRUCTURED_ONLY_MEDIA_BUY_ACTIONS = [] as const;
