...
export const PRODUCTS: MockProduct[] = [
  ...
  {
    product_id: 'acme_ctv_trail_series_q2',
    name: 'Acme Outdoor — CTV Trail Series Q2',
    network_code: 'net_acmeoutdoor',
    delivery_type: 'guaranteed',
    channel: 'ctv',
    format_ids: ['video_30s'],
    ad_unit_ids: ['au_acmeoutdoor_billboards'],
    pricing: { model: 'cpm', cpm: 38.0, currency: 'USD', min_spend: 20_000 },
    availability: {
      start_date: '2026-04-01',
      end_date: '2026-06-30',
      available_impressions: 18_000_000,
    },
  },
  {
    product_id: 'acme_sports_preroll_q2',
    name: 'Acme Outdoor — Sports Preroll Q2',
    network_code: 'net_acmeoutdoor',
    delivery_type: 'guaranteed',
    channel: 'video',
    format_ids: ['video_30s', 'video_15s'],
    ad_unit_ids: ['au_acmeoutdoor_billboards'],
    pricing: { model: 'cpm', cpm: 32.0, currency: 'USD', min_spend: 18_000 },
    availability: {
      start_date: '2026-04-01',
      end_date: '2026-06-30',
      available_impressions: 24_000_000,
    },
  },
  {
