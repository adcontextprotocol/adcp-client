 ...
 * so existing consumers of `@adcp/sdk/signing` keep working.
 *
 * New code should import from the narrower surface that matches its role:
 *
 *   import { createSigningFetch } from '@adcp/sdk/signing/client';
 *   import { createExpressVerifier } from '@adcp/sdk/signing/server';
 *
