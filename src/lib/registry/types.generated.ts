...
// Generated at: 2026-09-15T20:42:57.053Z
...
export interface paths {
    ...
    "/api/registry/agents/{encodedUrl}/compliance": {
         ...
         * @description Returns detailed compliance status for a single agent, including track-level results, storyboard counts, timestamps, and an owner-only read-only agent-wide grading-profile comparison. The comparison is not an exact badge-role grade. Reading it never contacts the agent or changes public badge state.
         *
