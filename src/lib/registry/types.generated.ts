...
// Generated at: 2026-09-25T06:33:53.011Z
...
//   - selectAgentGradingProfile: requestBody.required = true. PUT /api/registry/agents/{encodedUrl}/grading-profile requires seven body fields (organization_id, role, adcp_version, selected_profile, assessment_id, expected_revision, idempotency_key) and performs a revision compare-and-swap, but omits requestBody.required.
...
export interface paths {
    ...
    "/api/brands/resolve": {
        ...
        /**
         * Resolve brand
         * @description Resolve a domain to its canonical brand identity. Follows brand.json redirects and returns the resolved brand with its house, architecture type, and optional manifest. The domain must be a bare DNS hostname.
         *
    ...
    "/api/brands/resolve/bulk": {
        ...
        /**
         * Bulk resolve brands
         * @description Resolve up to 25 domains to their canonical brand identities in a single request. Unresolvable domains map to `null`.
         *
    ...
    "/api/registry/brand/{domain}/force-crawl": {
         ...
         * @description Admin-only support endpoint that fetches a domain's live `/.well-known/brand.json`, persists valid origin evidence, and returns the before/after state. A verified owner remains labeled `source: hosted` because that field describes identity provenance; `new_source_type: brand_json` and `promoted: true` confirm that live origin evidence was adopted.
         *
         *     **Rate limits:** 5 minutes per domain, 30 requests per user per hour.
         */
        post: operations["forceBrandCrawl"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/registry/mirror-proposals": {
        ...
        /**
         * List community mirror proposals
         ...
         */
        get: operations["listCommunityMirrorProposals"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/registry/mirror-proposals/{id}": {
         ...
         */
        get: operations["getCommunityMirrorProposal"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/registry/mirror-proposals/{id}/approve": {
         ...
         */
        post: operations["approveCommunityMirrorProposal"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/registry/mirror-proposals/{id}/reject": {
        ...
        put?: never;
        /**
         * Reject community mirror proposal
         ...
         */
        post: operations["rejectCommunityMirrorProposal"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/public/agent-formats": {
        ...
        /**
         * Get creative-agent format capabilities
    ...
    "/api/policies/resolve": {
        ...
        /**
         * Resolve policy
         * @description Resolve a single policy by ID. Optionally pin to an immutable published version. Registry publications include canonical_content and its RFC 8785 SHA-256 content_digest; a version that was never published returns not found.
         */
    ...
    "/api/registry/crawl-request": {
         ...
         * @description Persist a durable re-crawl request for a publisher domain after updating adagents.json. Returns 202 only after the request is committed to the queue. Use the returned `crawl_request_id` with the status endpoint to observe completion.
         *
         *     **Rate limits:** 5 minutes per domain, 30 requests per user per hour.
         */
    ...
    "/api/registry/crawl-request/{crawlRequestId}": {
        ...
        /**
         * Get publisher crawl request status
         ...
         */
        get: operations["getCrawlRequest"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/registry/agents/{encodedUrl}/compliance": {
         ...
         * @description Returns detailed compliance status for a single agent, including track-level results, storyboard counts, timestamps, and owner-only grading comparisons. Exact badge-scope rows compare Legacy and Strict Spec grading for one role/version; Sandbox remains preview-only. Reading never contacts the agent.
         *
    ...
    "/api/registry/agents/{encodedUrl}/grading-profile": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         */
        put: operations["selectAgentGradingProfile"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/api/registry/agents/{encodedUrl}/verification": {
        ...
        /**
         * Get agent AgenticAdvertising.org Verified status
    ...
    "/api/registry/agents/{encodedUrl}/monitoring/requeue": {
         ...
         * @description Clears the agent's next scheduled check time so it is picked up on the next heartbeat cycle (within ~1 hour). This is queued-async; it does not run the compliance suite synchronously or change the current verdict until the heartbeat completes. Requires authentication and ownership.
         */
...
export interface components {
    schemas: {
        ...
        AgentCompliance: {
            provenance?: components["schemas"]["ComplianceRunProvenance"];
            /** @enum {string} */
            ...
            verified_roles?: components["schemas"]["BadgeRole"][];
        ...
        ComplianceRunProvenance: {
            ...
            sdk_version: string;
            /** @description Agent-reported adcp.build_version; null when not supplied. Never inferred from the endpoint. */
        ...
        /** @enum {string} */
        BadgeRole: "media-buy" | "creative" | "signals" | "governance" | "brand" | "sponsored-intelligence";
        PropertySummary: {
            total_count: number;
            count_by_type: {
                [key: string]: number;
        ...
        CommunityMirrorProposalListResponse: {
            proposals: components["schemas"]["CommunityMirrorProposalSummary"][];
            total: number;
        };
        ...
        CommunityMirrorProposalGetResponse: {
            proposal: components["schemas"]["CommunityMirrorProposal"];
        };
        ...
        CommunityMirrorProposalApprovalResponse: components["schemas"]["CommunityMirrorPublishResponse"] & {
            /**
             * Format: uuid
             * @description Opaque identifier for the proposal.
             * @example 4ec8bc86-6180-4d0e-aa72-9cbf402d3638
        ...
        PolicySummary: {
            ...
            /** @description Machine-readable identity of the authoritative policy issuer */
            issuer: {
                domain: string;
                name?: string;
            } | null;
        ...
        Policy: {
            ...
            /** @description Version-pinned structured acceptance profile published with an authoritative registry policy */
            acceptance_profile: {
                profile_id: string;
                version: string;
                ...
                scope?: {
                    ...
                    applies_to: ("account" | "media_buy" | "creative" | "landing_page" | "targeting" | "delivery" | "format")[];
                    jurisdictions?: string[];
                ...
                rules: {
                    ...
                    requirements?: ({
                        ...
                        restricted_attributes?: ("racial_ethnic_origin" | "political_opinions" | "religious_beliefs" | "trade_union_membership" | "health_data" | "sex_life_sexual_orientation" | "genetic_data" | "biometric_data" | "age" | "familial_status")[];
                        description?: string;
                    } | {
                        /** @enum {string} */
            ...
            /** @description SHA-256 of the RFC 8785 (JCS) serialization of canonical_content. Present for immutable registry publications; null for legacy or community policies. */
            content_digest: string | null;
            /** @description Exact immutable registry policy document covered by content_digest. This excludes acceptance_profile, which has its own digest. Consumers MUST canonicalize this object with RFC 8785 before verifying content_digest. */
            canonical_content: {
                [key: string]: unknown;
            } | null;
        ...
        CollectionEventPayload: {
            ...
            /** @description Normalized collection body (core/collection.json shape). On authoritative projections, third-party distribution[] entries carry a registry-computed `host_confirmed` boolean: whether the host's own adagents.json affirmatively names the owning publisher in a collections selector reaching the claimed properties. It corroborates the (owner, collection, host, properties) path ONLY — it says nothing about the entry's identifiers[]. It is derived from the host manifest cached at the owner's last projection — never publisher-authored (the origin registry strips publisher-supplied values) — so a host that withdraws its grant leaves a stale true until the owner's next crawl, and false covers both 'host does not corroborate' and 'host not yet crawled'. Absent on community-contributed projections, self-carriage (host == owner) entries, and entries past the per-collection annotation cap. Mirrors consuming this feed re-serve whatever the feed carried and MUST NOT present the flag as locally verified. Carriage remains discovery data; for enforcement use the supply-path verifier or the authoritative files. */
            collection?: {
                [key: string]: unknown;
            };
            changed_fields?: string[];
        ...
        AgentComplianceDetail: {
            ...
            selected_grading_statuses?: {
                role: components["schemas"]["BadgeRole"];
                adcp_version: string;
                /** @enum {string} */
                grading_profile: "legacy" | "spec";
                /** @enum {string|null} */
                grading_status: "passing" | "partial" | "failing" | null;
                /** @enum {string} */
            ...
            refresh_availability?: {
                available: boolean;
                /** @description Whether retrying the same human refresh request later is expected to succeed without a platform change. */
                retryable: boolean;
                /** @enum {string} */
                scope: "platform";
                /** @enum {string} */
            ...
            eligibility?: components["schemas"]["ComplianceEligibility"];
            ...
            notices?: components["schemas"]["PublicComplianceNotice"][];
            ...
            eligibility_owner?: components["schemas"]["OwnerComplianceEligibility"];
            /**
            ...
            grading_profile_comparisons?: components["schemas"]["GradingProfileComparison"][];
        };
        ...
        ComplianceEligibility: {
            ...
            roles: {
                "media-buy"?: components["schemas"]["RoleEligibility"];
                creative?: components["schemas"]["RoleEligibility"];
                signals?: components["schemas"]["RoleEligibility"];
                governance?: components["schemas"]["RoleEligibility"];
                brand?: components["schemas"]["RoleEligibility"];
                "sponsored-intelligence"?: components["schemas"]["RoleEligibility"];
            };
        };
        RoleEligibility: {
            eligible: boolean;
            blockers: components["schemas"]["RoleEligibilityBlocker"][];
        };
        RoleEligibilityBlocker: {
            /** @enum {string} */
            code: "storyboards_failing" | "storyboards_partial" | "storyboards_untested";
        };
        ...
        VerificationBadge: {
            role: components["schemas"]["BadgeRole"] & unknown;
            ...
            /** @description Evidence modes earned. 'spec' = AdCP storyboards were exercised; 'live' = production traffic was observed. Independent of grading_profile and always non-empty when a badge is present. */
             ...
             */
            first_failing_spec_at?: string | null;
        ...
        GradingProfileComparison: {
            ...
            adcp_version?: string;
            /** @enum {string} */
            availability: "current" | "stale" | "pending" | "temporarily_unavailable";
            unavailable_reason: string | null;
            /** @enum {string} */
            selected_profile: "legacy" | "spec";
            ...
            profiles: {
                legacy: {
                    available: boolean;
                    /** @enum {string|null} */
                    status: "passing" | "partial" | "failing" | null;
                    /** @enum {string|null} */
                    observed_status: "passing" | "partial" | "failing" | null;
                    explanation: string;
                    /** Format: uuid */
                    assessment_id?: string;
                    selectable?: boolean;
                    /** @enum {string} */
                    public_effect?: "unchanged" | "issue" | "restore" | "regrade" | "degrade" | "revoke";
                    /** Format: date-time */
            ...
            evidence: {
                specialisms: string[];
                relevant_bundle_count: number;
                relevant_bundle_ids: string[];
                failing_bundle_count: number;
                incomplete_bundle_count: number;
                relevant_failure_count: number;
                missing_universal_bundle: boolean;
                missing_protocol_bundle: boolean;
                missing_specialism_bundles: string[];
                evaluator: string;
            };
        };
        AgentVerification: {
        ...
        ComplianceRun: {
            ...
            id: string;
            /** @enum {string} */
            completeness?: "complete" | "timed_out" | "not_completed";
...
export interface operations {
    ...
    listBrands: {
        parameters: {
            query?: {
                ...
                source?: "hosted" | "brand_json" | "enriched" | "community" | "stub";
            };
            header?: never;
            path?: never;
            cookie?: never;
    ...
    listAgents: {
        parameters: {
            query?: {
                ...
                creative_operation?: ("build" | "validate" | "preview") | ("build" | "validate" | "preview")[];
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        domain: string;
                        /** @enum {string|null} */
                        previous_source: "hosted" | "brand_json" | "community" | "enriched" | "stub" | null;
                        /** @enum {string|null} */
                        new_source: "hosted" | "brand_json" | "community" | "enriched" | "stub" | null;
                        /** @enum {string|null} */
                        previous_source_type: "brand_json" | "community" | "enriched" | "stub" | null;
                        /** @enum {string|null} */
                        new_source_type: "brand_json" | "community" | "enriched" | "stub" | null;
                        /** @description True when the crawl replaced lower-trust stored evidence with live brand.json evidence. */
                        promoted: boolean;
                        brand_json_found: boolean;
                        /** @enum {string|null} */
                        live_variant: "authoritative_location" | "house_redirect" | "brand_agent" | "house_portfolio" | "brand_canonical" | null;
                        has_manifest: boolean;
                        /** Format: date-time */
                        checked_at: string;
                    };
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        /**
                         * @description Canonical supply-path evaluator semantics; pinned by the shared supply-path golden vectors.
                         * @enum {string}
                         */
                        semantics_version: "1";
                        /** @description Concrete collection chosen for the complete path, including domain-level inquiries. */
    ...
    listCommunityMirrorProposals: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["CommunityMirrorProposalListResponse"];
                };
            };
    ...
    getCommunityMirrorProposal: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["CommunityMirrorProposalGetResponse"];
                };
            };
    ...
    approveCommunityMirrorProposal: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CommunityMirrorProposalReviewRequest"];
            };
        };
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["CommunityMirrorProposalApprovalResponse"];
                };
            };
    ...
    rejectCommunityMirrorProposal: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CommunityMirrorProposalRejectRequest"];
            };
        };
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["CommunityMirrorProposalDecisionResponse"];
                };
            };
    ...
    publishCommunityMirror: {
        ...
        responses: {
            ...
            202: {
                ...
                content: {
                    "application/json": components["schemas"]["CommunityMirrorProposalSubmissionResponse"];
                };
            };
            ...
            503: {
                ...
                content: {
                    "application/json": {
                        error: string;
                        /** @enum {string} */
                        code: "crawl_queue_unavailable" | "crawl_queue_at_capacity";
                        retry_after: number;
                    };
                };
            };
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        ...
                        domain: string;
                        /** @enum {string} */
                        status: "queued" | "running" | "deferred" | "retrying" | "completed" | "invalid" | "failed";
                        attempts: number;
                        max_attempts: number;
                        /** Format: date-time */
                        requested_at: string;
    ...
    selectAgentGradingProfile: {
        ...
        requestBody: {
            content: {
                "application/json": {
                    ...
                    acknowledge_public_impact?: boolean;
                    /** Format: uuid */
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        ...
                        source_run_id: string;
                        /** @enum {string} */
                        token_refresh: "completed" | "scheduled";
                    };
                };
            };
            /** @description Invalid request */
            ...
            /** @description Organization owner/admin required */
            403: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Stale assessment/revision, disabled selection, or impact confirmation required */
            409: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            400: {
                ...
                content: {
                    "application/json": {
                        ...
                        code: "invalid_role";
                        message: string;
                        valid_roles: components["schemas"]["BadgeRole"][];
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        ...
                        run_id: string | null;
                        /** @enum {string|null} */
                        completeness: "complete" | "timed_out" | "not_completed" | null;
                        is_authoritative: boolean;
                        provenance: components["schemas"]["ComplianceRunProvenance"];
                        storyboard_statuses: unknown[];
            ...
            200: {
                ...
                content: {
                    "application/json": {
                        ...
                        compliance: {
                            /** @description True if a compliance run was recorded. Check completeness and is_authoritative before treating its results as the public grade. */
                            ran: boolean;
                            /** @enum {string} */
                            completeness?: "complete" | "timed_out" | "not_completed";
                            /** @description Only authoritative runs update the public grade and badge state. Incomplete runs preserve the previous complete assessment. */
                            is_authoritative?: boolean;
                            provenance?: components["schemas"]["ComplianceRunProvenance"];
            ...
            503: {
                ...
                content: {
                    "application/json": {
                        ...
                        /**
                         * Format: uri
                         * @description Issue tracking the restoration of human-initiated refresh
                         */
    ...
    getAgentRefreshOperation: {
        ...
        responses: {
            ...
            /** @description Refresh status or administrator authorization temporarily unavailable */
            503: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    listMemberAgents: {
        parameters: {
            query?: {
                /** @description WorkOS organization id to act on. Human sessions and user JWTs must select it explicitly. WorkOS API keys may omit it because their validated credential already carries an exact organization scope; when supplied with an API key it must match that scope. */
                org?: string;
            };
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            /** @description The API key has a WorkOS organization scope, but the existing organization has not been provisioned locally. Reconcile it; do not create a duplicate. */
            409: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    registerMemberAgent: {
        ...
        responses: {
            ...
            /** @description Missing or invalid `url`, or missing/invalid `type`. */
            400: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description A human credential omitted `?org=`, the caller is not a member of the selected organization, or the selector conflicts with the API key scope. */
            403: {
                headers: {
                    [name: string]: unknown;
                };
