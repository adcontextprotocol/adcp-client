...
// Generated at: 2026-05-27T02:13:23.358Z
...
export interface paths {
    ...
    "/api/registry/agents/{encodedUrl}/refresh": {
         ...
         * @description Re-probe the agent and update its registry health (online, tools_count, response_time_ms), capability snapshot (inferred type, discovered tools), and compliance verdict (storyboard pass/fail counts). Use after fixing your agent so the registry shows fresh data without waiting for the periodic heartbeat (~12h).
         *
