...
// Generated at: 2026-06-26T23:17:10.642Z
...
export interface paths {
    ...
    "/api/brands/hierarchy": {
        ...
        /**
         * Resolve brand hierarchy
         * @description Resolve a domain to its ordered corporate brand hierarchy, from self through parents to house.
         */
        get: operations["resolveBrandHierarchy"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/brands/hierarchy/bulk": {
        ...
        put?: never;
        /**
         * Bulk resolve brand hierarchies
         * @description Resolve up to 100 domains to ordered corporate brand hierarchies in a single request.
         */
        post: operations["resolveBrandHierarchies"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        BrandHierarchyResolution: {
            /** @description Ordered corporate brand chain from the resolved brand itself through each parent to the house brand. */
            chain: components["schemas"]["ResolvedBrand"][];
        };
        LocalizedName: {
            [key: string]: string;
        };
...
export interface operations {
    ...
    resolveBrandHierarchy: {
        ...
        requestBody?: never;
        responses: {
            /** @description Brand hierarchy resolved successfully */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["BrandHierarchyResolution"];
                };
            };
            /** @description Brand not found */
            404: {
    ...
    resolveBrandHierarchies: {
        ...
        responses: {
            /** @description Bulk hierarchy resolution results */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": {
                        results: {
                            [key: string]: components["schemas"]["BrandHierarchyResolution"] | null;
                        };
                    };
                };
            };
