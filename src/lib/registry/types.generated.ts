...
// Generated at: 2026-04-12T10:48:51.774Z
...
export interface components {
    schemas: {
        ResolvedBrand: {
            ...
            /**
             * @description When true, this brand is a test fixture for storyboard validation. Sandbox brands resolve normally but are excluded from production brand discovery.
             * @default false
             */
            sandbox: boolean;
        };
        ...
        BrandRegistryItem: {
            ...
            keller_type?: "master" | "sub_brand" | "endorsed" | "independent";
            /**
             * @description When true, this brand is a test fixture for storyboard validation.
             * @default false
             */
            sandbox: boolean;
        };
        ...
        OperatorLookupResult: {
            ...
            agents: {
                ...
                name: string;
                /** @enum {string} */
                type: "creative" | "signals" | "sales" | "governance" | "si" | "buyer" | "unknown";
                authorized_by: {
                    publisher_domain: string;
                    authorized_for?: string;
                    /** @enum {string} */
        ...
        requestBody?: {
            content: {
                "application/json": {
                    ...
                    /** @description When true, registers this brand as a test fixture. Sandbox brands resolve normally but are excluded from production brand discovery and listing (unless explicitly requested with include_sandbox=true). */
                    sandbox?: boolean;
                };
            };
        };
    ...
    listBrands: {
        parameters: {
            query?: {
                ...
                limit?: number;
                offset?: number;
                /** @description Include sandbox (test fixture) brands in the results. Defaults to false. */
                include_sandbox?: "true" | "false";
            };
            header?: never;
            path?: never;
            cookie?: never;
