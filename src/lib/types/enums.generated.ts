...
export const NotificationTypeValues = ["scheduled", "final", "delayed", "adjusted", "impairment", "creative.status_changed", "creative.purged"] as const;
