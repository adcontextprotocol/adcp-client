...
export const CreativeEventReasonCodeValues = ["review_passed", "review_failure", "processing_failure", "seller_rereview", "policy_revocation", "content_drift", "takedown_request", "advertiser_request", "seller_archive", "account_closed", "account_suspended", "retention_expired", "legal_erasure"] as const;
...
export const ErrorCodeValues = ["INVALID_REQUEST", "AUTH_REQUIRED", "AUTH_MISSING", "AUTH_INVALID", "RATE_LIMITED", "SERVICE_UNAVAILABLE", "CONFIGURATION_ERROR", "POLICY_VIOLATION", "PRODUCT_NOT_FOUND", "PRODUCT_UNAVAILABLE", "PROPOSAL_EXPIRED", "BUDGET_TOO_LOW", "CREATIVE_REJECTED", "CREATIVE_VALUE_NOT_ALLOWED", "UNSUPPORTED_FEATURE", "UNSUPPORTED_GRANULARITY", "UNSUPPORTED_PROVISIONING", "AUDIENCE_TOO_SMALL", "ACCOUNT_NOT_FOUND", "ACCOUNT_SETUP_REQUIRED", "ACCOUNT_AMBIGUOUS", "ACCOUNT_PAYMENT_REQUIRED", "ACCOUNT_SUSPENDED", "COMPLIANCE_UNSATISFIED", "GOVERNANCE_DENIED", "BUDGET_EXHAUSTED", "BUDGET_EXCEEDED", "CONFLICT", "IDEMPOTENCY_CONFLICT", "IDEMPOTENCY_EXPIRED", "IDEMPOTENCY_IN_FLIGHT", "CREATIVE_DEADLINE_EXCEEDED", "INVALID_STATE", "MEDIA_BUY_NOT_FOUND", "NOT_CANCELLABLE", "PACKAGE_NOT_FOUND", "CREATIVE_NOT_FOUND", "SIGNAL_NOT_FOUND", "SESSION_NOT_FOUND", "PLAN_NOT_FOUND", "REFERENCE_NOT_FOUND", "SESSION_TERMINATED", "VALIDATION_ERROR", "PRODUCT_EXPIRED", "PROPOSAL_NOT_COMMITTED", "PROPOSAL_NOT_FOUND", "MULTI_FINALIZE_UNSUPPORTED", "IO_REQUIRED", "TERMS_REJECTED", "REQUOTE_REQUIRED", "VERSION_UNSUPPORTED", "CAMPAIGN_SUSPENDED", "GOVERNANCE_UNAVAILABLE", "PERMISSION_DENIED", "SCOPE_INSUFFICIENT", "READ_ONLY_SCOPE", "FIELD_NOT_PERMITTED", "PROVENANCE_REQUIRED", "PROVENANCE_DIGITAL_SOURCE_TYPE_MISSING", "PROVENANCE_DISCLOSURE_MISSING", "PROVENANCE_EMBEDDED_MISSING", "PROVENANCE_VERIFIER_NOT_ACCEPTED", "PROVENANCE_CLAIM_CONTRADICTED", "BILLING_NOT_SUPPORTED", "BILLING_NOT_PERMITTED_FOR_AGENT", "BILLING_OUT_OF_BAND", "PAYMENT_TERMS_NOT_SUPPORTED", "BRAND_REQUIRED", "AGENT_SUSPENDED", "AGENT_BLOCKED", "CREDENTIAL_IN_ARGS", "ACTION_NOT_ALLOWED", "PRIVATE_FIELD_IN_PUBLIC_PLACEMENT", "FORMAT_PROJECTION_FAILED", "FORMAT_DECLARATION_DIVERGENT", "FORMAT_DECLARATION_V1_AMBIGUOUS", "FORMAT_OPTION_UNRESOLVED", "FORMAT_DECLARATION_V1_LOSSY_MULTI_SIZE", "FORMAT_NOT_SUPPORTED", "PIXEL_TRACKER_LOSSY_DOWNGRADE", "PIXEL_TRACKER_UPGRADE_INFERRED", "STALE_RESPONSE"] as const;
...
export const ImpairmentReasonCodeValues = ["policy_violation", "consent_expired", "ttl_expired", "pii_audit_failed", "seller_removed", "content_rejected", "source_offline", "property_depublished"] as const;
...
export const MediaBuyActionModeValues = ["self_serve", "conditional_self_serve", "requires_proposal", "requires_approval"] as const;
...
export const TaskTypeValues = ["create_media_buy", "update_media_buy", "media_buy_delivery", "sync_creatives", "activate_signal", "get_signals", "create_property_list", "update_property_list", "get_property_list", "list_property_lists", "delete_property_list", "sync_accounts", "get_account_financials", "get_creative_delivery", "sync_event_sources", "sync_audiences", "sync_catalogs", "log_event", "get_brand_identity", "search_brands", "get_rights", "acquire_rights"] as const;
...
export const XEntityTypesValues = ["advertiser_brand", "rights_holder_brand", "rights_grant", "account", "operator", "media_buy", "package", "product", "placement", "product_pricing_option", "vendor_pricing_option", "creative", "creative_format", "audience", "signal", "signal_activation_id", "event_source", "impairment", "collection_list", "property_list", "catalog", "property", "media_plan", "governance_plan", "governance_registry_policy", "governance_inline_policy", "governance_check", "content_standards", "task", "si_session", "offering", "vendor_metric"] as const;
