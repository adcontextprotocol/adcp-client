...
export const ReportCalendarTimezoneBasisValues = ["utc", "account_timezone", "configured_timezone"] as const;
...
export const ReportingScheduleAlignmentValues = ["utc", "account_timezone", "billing_cycle"] as const;
