// AUTO-GENERATED FROM schemas/cache/3.0.10/manifest.json — DO NOT EDIT.
// Run `npm run generate-manifest-derived` to regenerate.

/**
 * Manifest-derived constants for AdCP 3.0.10.
 *
 ...
 *
 * Source: `schemas/cache/3.0.10/manifest.json` (adcp_version: 3.0.10, generated_at:
 * 2026-05-10T23:16:18.042Z). Re-run `npm run sync-schemas` then
