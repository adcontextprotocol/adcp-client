// AUTO-GENERATED FROM schemas/cache/3.1.0-rc.2/manifest.json — DO NOT EDIT.
// Run `npm run generate-manifest-derived` to regenerate.

/**
 * Manifest-derived constants for AdCP 3.1.0-rc.2.
 *
 ...
 *
 * Source: `schemas/cache/3.1.0-rc.2/manifest.json` (adcp_version: 3.1.0-rc.2, generated_at:
 * 2026-05-29T21:35:41.473Z). Re-run `npm run sync-schemas` then
