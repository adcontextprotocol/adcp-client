// AUTO-GENERATED FROM schemas/cache/3.1.14/manifest.json — DO NOT EDIT.
// Run `npm run generate-manifest-derived` to regenerate.

/**
 * Manifest-derived constants for AdCP 3.1.14.
 *
 ...
 *
 * Source: `schemas/cache/3.1.14/manifest.json` (adcp_version: 3.1.14, generated_at:
 * 2026-08-15T20:02:32.707Z). Re-run `npm run sync-schemas` then
