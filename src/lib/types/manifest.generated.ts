// AUTO-GENERATED FROM schemas/cache/3.2.0-beta.2/manifest.json — DO NOT EDIT.
// Run `npm run generate-manifest-derived` to regenerate.

/**
 * Manifest-derived constants for AdCP 3.2.0-beta.2.
 *
 ...
 *
 * Source: `schemas/cache/3.2.0-beta.2/manifest.json` (adcp_version: 3.2.0-beta.2, generated_at:
 * 2026-08-19T05:22:22.244Z). Re-run `npm run sync-schemas` then
