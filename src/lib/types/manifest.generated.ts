// AUTO-GENERATED FROM schemas/cache/3.0.4/manifest.json — DO NOT EDIT.
// Run `npm run generate-manifest-derived` to regenerate.

/**
 * Manifest-derived constants for AdCP 3.0.4.
 *
 ...
 *
 * Source: `schemas/cache/3.0.4/manifest.json` (adcp_version: 3.0.4, generated_at:
 * 2026-05-02T11:07:10.010Z). Re-run `npm run sync-schemas` then
