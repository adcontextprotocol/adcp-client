...
// Generated at: 2025-11-05T14:41:59.151Z
// Sources:
...
export const MediaBuyStatusSchema = z.union([
  z.literal('pending_activation'),
  z.literal('active'),
  z.literal('paused'),
  z.literal('completed'),
]);
...
export const PackageStatusSchema = z.union([
  z.literal('draft'),
  z.literal('active'),
  z.literal('paused'),
  z.literal('completed'),
...
export const VASTAsset1Schema = z.object({
  ...
  vast_version: z
    .union([z.literal('2.0'), z.literal('3.0'), z.literal('4.0'), z.literal('4.1'), z.literal('4.2')])
    .optional(),
  ...
  tracking_events: z
    .array(
      z.union([
        z.literal('start'),
        z.literal('firstQuartile'),
        z.literal('midpoint'),
        z.literal('thirdQuartile'),
        z.literal('complete'),
        ...
        z.literal('exitFullscreen'),
        z.literal('playerExpand'),
        z.literal('playerCollapse'),
      ])
    )
    .optional(),
});

export const VASTAsset2Schema = z.union([z.record(z.string(), z.unknown()), z.record(z.string(), z.unknown())]);
...
export const DAASTAsset2Schema = z.union([z.record(z.string(), z.unknown()), z.record(z.string(), z.unknown())]);
...
export const BrandManifest2Schema = z.object({
  ...
  product_catalog: z
    .object({
      feed_url: z.string(),
      feed_format: z
        .union([z.literal('google_merchant_center'), z.literal('facebook_catalog'), z.literal('custom')])
        .optional(),
      categories: z.array(z.string()).optional(),
      last_updated: z.string().optional(),
      update_frequency: z
        .union([z.literal('realtime'), z.literal('hourly'), z.literal('daily'), z.literal('weekly')])
        .optional(),
    })
    .optional(),
  disclaimers: z
...
export const PricingOptionSchema = z.union([
...
export const ReportingCapabilitiesSchema = z.object({
  available_reporting_frequencies: z
    .tuple([z.union([z.literal('hourly'), z.literal('daily'), z.literal('monthly')])])
    .rest(z.union([z.literal('hourly'), z.literal('daily'), z.literal('monthly')])),
  expected_delay_minutes: z.number(),
  timezone: z.string(),
  supports_webhooks: z.boolean(),
  available_metrics: z.array(
    z.union([
      z.literal('impressions'),
      z.literal('spend'),
      z.literal('clicks'),
      z.literal('ctr'),
      z.literal('video_completions'),
      z.literal('completion_rate'),
      z.literal('conversions'),
      z.literal('viewability'),
...
export const PropertyIdentifierTypesSchema = z.union([
  z.literal('domain'),
  z.literal('subdomain'),
...
export const CreativeStatusSchema = z.union([
...
export const CreativeStatus1Schema = z.union([
  z.literal('processing'),
  z.literal('approved'),
  z.literal('rejected'),
  z.literal('pending_review'),
...
export const SubAsset1Schema = z.object({
...
export const SubAsset2Schema = z.union([z.record(z.string(), z.unknown()), z.record(z.string(), z.unknown())]);

export const SubAssetSchema = SubAsset1Schema.and(SubAsset2Schema);
...
export const PricingModelSchema = z.union([
  z.literal('cpm'),
  z.literal('vcpm'),
  z.literal('cpc'),
  z.literal('cpcv'),
...
export const DeliveryMetricsSchema = z.record(z.string(), z.unknown()).and(
  z.object({
...
export const AdvertisingChannelsSchema = z.union([
  z.literal('display'),
  z.literal('video'),
  z.literal('audio'),
  z.literal('native'),
...
export const ProvidePerformanceFeedbackRequestSchema = z.object({
  ...
  metric_type: z
    .union([
      z.literal('overall_performance'),
      z.literal('conversion_rate'),
      z.literal('brand_lift'),
      z.literal('click_through_rate'),
      z.literal('completion_rate'),
      z.literal('viewability'),
      z.literal('brand_safety'),
      z.literal('cost_efficiency'),
    ])
    .optional(),
  feedback_source: z
    .union([
      z.literal('buyer_attribution'),
      z.literal('third_party_measurement'),
      z.literal('platform_analytics'),
      z.literal('verification_partner'),
    ])
    .optional(),
});
...
export const ListCreativesRequestSchema = z.object({
  ...
  sort: z
    .object({
      field: z
        .union([
          z.literal('created_date'),
          z.literal('updated_date'),
          z.literal('name'),
          z.literal('status'),
          z.literal('assignment_count'),
          z.literal('performance_score'),
        ])
        .optional(),
...
export const GetMediaBuyDeliveryResponseSchema = z.object({
  notification_type: z
    .union([z.literal('scheduled'), z.literal('final'), z.literal('delayed'), z.literal('adjusted')])
    .optional(),
  ...
  creative_agents: z
    .array(
      z.object({
        ...
        capabilities: z
          .array(
            z.union([z.literal('validation'), z.literal('assembly'), z.literal('generation'), z.literal('preview')])
          )
          .optional(),
      })
    )
...
export const CreateMediaBuyRequestSchema = z.object({
  ...
  end_time: z.string(),
  reporting_webhook: PushNotificationConfigSchema.and(
    z.object({
