...
// Generated at: 2026-03-17T02:13:27.853Z
// Sources:
...
export const OptimizationGoalSchema = z.union([z.object({
        ...
        target_frequency: z.record(z.string(), z.union([z.unknown(), z.undefined()])).nullish(),
...
export const GeographicBreakdownSupportSchema = z.object({
    ...
    metro: z.record(z.string(), z.union([z.boolean(), z.undefined()])).nullish(),
    postal_area: z.record(z.string(), z.union([z.boolean(), z.undefined()])).nullish()
}).passthrough();
...
export const ShowCadenceSchema = z.union([z.literal("daily"), z.literal("weekly"), z.literal("seasonal"), z.literal("event"), z.literal("irregular")]);

export const ShowStatusSchema = z.union([z.literal("active"), z.literal("hiatus"), z.literal("ended"), z.literal("upcoming")]);

export const ProductionQualitySchema = z.union([z.literal("professional"), z.literal("prosumer"), z.literal("ugc")]);

export const DistributionIdentifierTypeSchema = z.union([z.literal("apple_podcast_id"), z.literal("spotify_show_id"), z.literal("rss_url"), z.literal("podcast_guid"), z.literal("amazon_music_id"), z.literal("iheart_id"), z.literal("podcast_index_id"), z.literal("youtube_channel_id"), z.literal("youtube_playlist_id"), z.literal("amazon_title_id"), z.literal("roku_channel_id"), z.literal("pluto_channel_id"), z.literal("tubi_id"), z.literal("peacock_id"), z.literal("tiktok_id"), z.literal("twitch_channel"), z.literal("imdb_id"), z.literal("gracenote_id"), z.literal("eidr_id"), z.literal("domain"), z.literal("substack_id")]);

export const ShowRelationshipSchema = z.union([z.literal("spinoff"), z.literal("companion"), z.literal("sequel"), z.literal("prequel"), z.literal("crossover")]);
...
export const ShowDistributionSchema = z.object({
    publisher_domain: z.string(),
    identifiers: z.array(z.object({
...
export const ShowSchema = z.object({
    ...
    cadence: ShowCadenceSchema.nullish(),
    season: z.string().nullish(),
    status: ShowStatusSchema.nullish(),
    production_quality: ProductionQualitySchema.nullish(),
    talent: z.array(TalentSchema).nullish(),
    distribution: z.array(ShowDistributionSchema).nullish(),
    related_shows: z.array(z.object({
        show_id: z.string(),
        relationship: ShowRelationshipSchema
    }).passthrough()).nullish(),
    ext: ExtensionObjectSchema.nullish()
}).passthrough();
...
export const EpisodeSchema = z.object({
    episode_id: z.string(),
    show_id: z.string().nullish(),
    name: z.string().nullish(),
    season: z.string().nullish(),
    episode_number: z.string().nullish(),
    scheduled_at: z.string().nullish(),
    status: EpisodeStatusSchema.nullish(),
...
export const OverlaySchema = z.object({
    ...
    bounds: z.object({
        ...
        width: z.number(),
        height: z.number(),
        unit: z.union([z.literal("px"), z.literal("fraction")])
    }).passthrough()
}).passthrough();
...
export const TargetingOverlaySchema = z.object({
    ...
    geo_proximity: z.array(z.record(z.string(), z.union([z.unknown(), z.undefined()]))).nullish(),
...
export const UserMatchSchema = z.record(z.string(), z.union([z.unknown(), z.undefined()])).and(z.object({
...
export const AudienceMemberSchema = z.record(z.string(), z.union([z.unknown(), z.undefined()])).and(z.object({
    ...
    plans: z.array(z.object({
        ...
        channels: z.object({
            ...
            mix_targets: z.record(z.string(), z.union([z.object({
                ...
                }).passthrough(), z.undefined()])).nullish()
        }).passthrough().nullish(),
        flight: z.object({
            start: z.string(),
            end: z.string()
...
export const GetPlanAuditLogsRequestSchema = z.record(z.string(), z.union([z.unknown(), z.undefined()])).and(z.object({
...
export const GetPlanAuditLogsResponseSchema = z.object({
    plans: z.array(z.object({
        ...
        campaigns: z.array(z.object({
            ...
            status: z.union([z.literal("active"), z.literal("suspended"), z.literal("completed")]),
            committed: z.number(),
            active_media_buys: z.array(z.string()).nullish()
        }).passthrough()),
        summary: z.object({
...
export const CheckGovernanceResponseSchema = z.object({
    ...
    conditions: z.array(z.object({
        field: z.string(),
        required_value: z.record(z.string(), z.union([z.unknown(), z.undefined()])).nullish(),
        reason: z.string()
    }).passthrough()).nullish(),
    escalation: z.object({
        reason: z.string(),
...
export const SIUIElementSchema = z.record(z.string(), z.union([z.unknown(), z.undefined()])).and(z.object({
...
export const A2UIComponentSchema = z.object({
    ...
    component: z.record(z.string(), z.union([z.object({}).passthrough(), z.undefined()]))
}).passthrough();
...
export const ProductSchema = z.object({
    ...
    show_ids: z.array(z.string()).nullish(),
...
export const GetProductsResponseSchema = z.object({
    ...
    shows: z.array(ShowSchema).nullish(),
...
export const PackageUpdateSchema = z.object({
    ...
    creatives: z.array(CreativeAssetSchema).nullish(),
    ext: ExtensionObjectSchema.nullish()
}).passthrough().and(z.record(z.string(), z.union([z.unknown(), z.undefined()])));
