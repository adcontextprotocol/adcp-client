...
// Generated at: 2026-02-23T17:08:32.179Z
// Sources:
...
import { z } from "zod";
import { type CatalogFieldBinding } from "./tools.generated";
...
export const CatalogFieldMappingSchema = z.record(z.string(), z.union([z.unknown(), z.undefined()])).and(z.record(z.string(), z.union([z.unknown(), z.undefined()]))).and(z.record(z.string(), z.union([z.unknown(), z.undefined()])).and(z.object({
    ...
    ext: ExtensionObjectSchema.nullish()
}))).and(z.record(z.string(), z.union([z.unknown(), z.undefined()])).and(z.object({
    feed_field: z.string().nullish(),
    catalog_field: z.string().nullish(),
    asset_group_id: z.string().nullish(),
    value: z.record(z.string(), z.union([z.unknown(), z.undefined()])).nullish(),
...
export const CatalogFieldBindingSchema: z.ZodTypeAny = z.lazy(() => z.record(z.string(), z.union([z.unknown(), z.undefined()])).and(z.object({
    asset_id: z.string().nullish(),
    format_group_id: z.string().nullish(),
    catalog_field: z.string().nullish(),
    asset_group_id: z.string().nullish(),
    catalog_item: z.literal(true).nullish(),
    per_item_bindings: z.tuple([CatalogFieldBindingSchema.and(z.record(z.string(), z.union([z.unknown(), z.undefined()])))]).rest(CatalogFieldBindingSchema.and(z.record(z.string(), z.union([z.unknown(), z.undefined()])))).nullish(),
    ext: ExtensionObjectSchema.nullish()
})).and(z.union([z.record(z.string(), z.union([z.unknown(), z.undefined()])), z.record(z.string(), z.union([z.unknown(), z.undefined()])), z.object({
