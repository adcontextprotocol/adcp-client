...
export const BrandManifest2Schema = z.object({
  ...
  product_catalog: z
    .object({
      ...
      feed_format: z
        .union([
          z.literal("google_merchant_center"),
          z.literal("facebook_catalog"),
          z.literal("custom"),
        ])
        .optional(),
...
export const JavaScriptAssetSchema = z.object({
  content: z.string(),
  module_type: z
    .union([z.literal("esm"), z.literal("commonjs"), z.literal("script")])
    .optional(),
});
...
export const ReportingCapabilitiesSchema = z.object({
  available_reporting_frequencies: z
    .tuple([
      z.union([z.literal("hourly"), z.literal("daily"), z.literal("monthly")]),
    ])
    .rest(
      z.union([z.literal("hourly"), z.literal("daily"), z.literal("monthly")])
    ),
...
export const CreativePolicySchema = z.object({
  ...
  landing_page: z.union([
    z.literal("any"),
    z.literal("retailer_site_only"),
    z.literal("must_include_retailer"),
  ]),
...
export const BrandManifestSchema =
  BrandManifest1Schema.and(BrandManifest2Schema);
...
export const PushNotificationConfigSchema = z.object({
  ...
  authentication: z.object({
    schemes: z.tuple([
      z.union([z.literal("Bearer"), z.literal("HMAC-SHA256")]),
    ]),
    ...
    z.object({
      ...
      deployments: z.array(
        z.object({
          ...
          is_live: z.boolean(),
          scope: z.union([
            z.literal("platform-wide"),
            z.literal("account-specific"),
          ]),
...
export const UpdateMediaBuyRequestSchema = UpdateMediaBuyRequest1Schema.and(
  UpdateMediaBuyRequest2Schema
);
