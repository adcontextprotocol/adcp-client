...
- `--compliance-version VERSION`: Select a packaged compliance cache/spec line, for example `3.1.18` or `3.2.0-rc.6`; use the same flag with `storyboard list`, `show`, and `step` when reproducing a pinned run
