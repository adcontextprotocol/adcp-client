...
| Fact | Value |
| --- | --- |
| Exact npm package | `@adcp/sdk@14.0.0-rc.37` |
| npm integrity | registry-derived after publication; run `npm view @adcp/sdk@14.0.0-rc.37 dist.integrity` |
...
```bash
npm install --save-exact '@adcp/sdk@14.0.0-rc.37'
npm view '@adcp/sdk@14.0.0-rc.37' dist.integrity
```
