...
[@adcp/client API Reference](../globals.md) / Format

# Interface: Format

Defined in: [src/lib/types/tools.generated.ts:1112](https://github.com/adcontextprotocol/adcp-client/blob/8b051702996bea03f2cc34f765f78723a45db572/src/lib/types/tools.generated.ts#L1112)

Represents a creative format with its requirements

## Extended by

- [`CreativeFormat`](CreativeFormat.md)
