...
- Missing-tool/controller producers also block consumers of their absent declared outputs with hard prerequisite skips; intentional unrelated negative vectors and successfully restored outputs still execute.
