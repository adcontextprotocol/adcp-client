...
- **Storyboard `provides_state_for` field** (3.0.3 — adcp#3734). Pairs with the cascade-skip mechanism shipped in 6.5.0; lets `sales-social` explicit-mode platforms graduate from `1/9/0` to `9/10` once their compliance cache refreshes.
